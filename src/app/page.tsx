...
const translations = {
  en: {
    ...
    fishing: "Fishing",
    fishingDesc: "Enjoy fishing in nearby river",
    pickup: "Free Pickup (3+ Nights)",
    pickupDesc: "Free pickup service for stays of 3 nights or more",
  ...
  km: {
    ...
    pickup: "ទទួលឥតគិតថ្លៃ (៣ យប់ឡើង)",
    pickupDesc: "សេវាទទួលភ្ញៀវឥតគិតថ្លៃសម្រាប់ការស្នាក់នៅ៣យប់ឡើងទៅ",
